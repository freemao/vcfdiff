...
def diff2vcf(x, y):
    ...
    for i in f1:
        if i.startswith('#'):
            ...
            k = ''.join(i.split()[0:5]) + '-' + i.split()[9].split(':')[0]
#below is a line of  vcf file generated by gatk
#Chr1 33667 . A   G   1011.77 . AC=2;AF=1.00;AN=2;DP=26;FS=0.000;MLEAC=2;MLEAF=1.00;MQ=50.00;MQ0=0;QD=26.89 GT:AD:DP:GQ:PL  1/1:0,26:26:78:1040,78,0
#the line of this code will get 'Chr133667.AG-1/1'  as same snp site in
#different callers maybe generate different type, for example A =
#2, R = 100, in freebayes is 0/0, in GATK maybe 0/1... SO i remove
#the part of '-1/1', alas... you understand
...
#    print xyz_siteandtype_intersection
